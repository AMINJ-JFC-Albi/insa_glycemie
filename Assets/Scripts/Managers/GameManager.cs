...
public class GameManager : MonoBehaviour {
    ...
    [SerializeField] internal DialogueManager dialogueManagerStep1;
    [SerializeField] internal DialogueManager dialogueManagerStep2;
    ...
    private void ShowPlacement() {
        ...
        dialogueManagerStep1?.ShowNextDialogue();
    ...
    private void ShowNextDialogueStep2() {
        dialogueManagerStep2?.ShowNextDialogue();
    }

    private void ShowRoom3() {
        LoggerTool.Log("ShowRoom3.");
        dialogueManagerStep2?.ShowNextDialogue();
        if ((dialogueManagerStep2 != null) && dialogueManagerStep2.TryGetComponent<FadeTeleport>(out FadeTeleport ft)) ft.StartVRTeleportSequence(player.transform);
